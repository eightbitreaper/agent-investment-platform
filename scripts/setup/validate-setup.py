...
class SetupValidator:
    ...
    def _generate_validation_report(self):
        ...
        report_lines.append(f"- **Passed**: {status_counts[ValidationResult.PASS]} ✅")
        report_lines.append(f"- **Failed**: {status_counts[ValidationResult.FAIL]} ❌")
        report_lines.append(f"- **Warnings**: {status_counts[ValidationResult.WARNING]} ⚠️")
        report_lines.append(f"- **Skipped**: {status_counts[ValidationResult.SKIP]} ⏭️")
        report_lines.append("")
        
        # Overall status
        if status_counts[ValidationResult.FAIL] > 0:
            report_lines.append("## Overall Status: ❌ VALIDATION FAILED")
        elif status_counts[ValidationResult.WARNING] > 0:
            report_lines.append("## Overall Status: ⚠️ VALIDATION PASSED WITH WARNINGS")
        else:
            report_lines.append("## Overall Status: ✅ VALIDATION PASSED")
        report_lines.append("")
        ...
        print("="*60)
        print(f"✅ Passed: {status_counts[ValidationResult.PASS]}")
        print(f"❌ Failed: {status_counts[ValidationResult.FAIL]}")
        print(f"⚠️  Warnings: {status_counts[ValidationResult.WARNING]}")
